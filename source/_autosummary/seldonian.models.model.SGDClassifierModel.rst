...
.. autoclass:: SGDClassifierModel
   ...
   ..
   ..    ~SGDClassifierModel.evaluate_statistic
   ..
   ..    ~SGDClassifierModel.fit
   ..
   ..    ~SGDClassifierModel.gradient_sample_logistic_loss
   ..
   ..    ~SGDClassifierModel.predict
   ..
   ..    ~SGDClassifierModel.sample_False_Negative_Rate
   ..
   ..    ~SGDClassifierModel.sample_False_Positive_Rate
   ..
   ..    ~SGDClassifierModel.sample_Negative_Rate
   ..
   ..    ~SGDClassifierModel.sample_Positive_Rate
   ..
   ..    ~SGDClassifierModel.sample_from_statistic
   ..
