...
def run_trial(
    ...
    if type(hyperparameter_and_setting_dict["agent"]) == str:
        ...
        print("Agent is directly provided")
...
def run_episode_par(create_env_func,create_agent_func):
    """Run a single episode. A function that can be parallelized. 
